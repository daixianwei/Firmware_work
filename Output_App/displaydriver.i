#line 1 "Management\\DisplayDriver\\DisplayDriver.c"
...
#line 17 "Management\\DisplayDriver\\DisplayDriver.c"
...
#line 18 "Management\\DisplayDriver\\DisplayDriver.c"
...
#line 19 "Management\\DisplayDriver\\DisplayDriver.c"
#line 20 "Management\\DisplayDriver\\DisplayDriver.c"
 ...
 void LCD_GPIO_Config(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x2000) |((uint16_t)0x0004);
 ...
 void RCC_Configuration(void)
 {
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000008)
...
volatile static void Delay(volatile u32 nCount)
{
	volatile int i;
	for(i=0;i<7200;i++)
    for(; nCount != 0; nCount--);
...
u16 ssd1289_GetPoint(u16 x,u8 y)
{
	...
	*(volatile u16 *) (((u32)0x60000000)) = 0x4f;
	*(volatile u16 *) (((u32)0x60020000)) = x;

	*(volatile u16 *) (((u32)0x60000000)) = 0x4e;
	*(volatile u16 *) (((u32)0x60020000)) = y;

	*(volatile u16 *) (((u32)0x60000000)) = 0x22;
...
{
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))->BRR = ((uint16_t)0x2000);;
    Delay(10000);
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))->BSRR = ((uint16_t)0x2000);;
    Delay(10000);
}
...
u16 ReadPixel(u16 x,u8 y)
{
	...
	WriteData(y&0xff);
	WriteComm(0x2e);
	dat = *(volatile u16 *) (((u32)0x60020000));printf("dat_1=%04x\r\n",dat);
	dat = *(volatile u16 *) (((u32)0x60020000));printf("dat_2=%04x\r\n",dat);
	temp = *(volatile u16 *) (((u32)0x60020000));printf("dat_3=%04x\r\n",temp);
...
WriteComm(0x29);				
	...
	Delay_ms_SW(2000);
    if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0010)))
    {
...
void Lcd_Display_Clear(void)
{
	...
	{
		*(volatile u16 *) (((u32)0x60020000)) = 0>>8;
		*(volatile u16 *) (((u32)0x60020000)) = 0;
	}
}

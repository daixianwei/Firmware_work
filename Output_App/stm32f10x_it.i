...
#line 8 "ISR\\stm32f10x_it.c"
#line 1 "ISR\\stm32f10x_it.h"
...
#line 12 "ISR\\stm32f10x_it.h"
#line 13 "ISR\\stm32f10x_it.h"

 
char tbuf1[10] = {0};
uint16 Count_Down = 0;
uint8 Exti_lock = DISABLE;
uint16 hours = 11,minutes =11,seconds = 01; 		
...
#line 9 "ISR\\stm32f10x_it.c"
#line 10 "ISR\\stm32f10x_it.c"
#line 11 "ISR\\stm32f10x_it.c"
...
void Delay_ms_SW(volatile uint32 nCount)
{
...
void TIM3_IRQHandler(void)
{
	...
	TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ENABLE ); 			
}
...
void EXTI4_IRQHandler(void)
{
	if(Exti_lock)
	{
		if(EXTI_GetITStatus(((uint32_t)0x00010)))	 		
		{
			key_fall_flag = 1;						
...
{	 
	if(Exti_lock)
	{
		if(EXTI_GetITStatus(((uint32_t)0x00100)))	 		
		{
			Delay_ms_SW((180));
			if(EXTI_GetITStatus(((uint32_t)0x00100)))	 	
			{
		...
		if(EXTI_GetITStatus(((uint32_t)0x00200)))	 		
		{
			Delay_ms_SW((180));
			if(EXTI_GetITStatus(((uint32_t)0x00200)))	 	
			{

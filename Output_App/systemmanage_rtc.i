#line 1 "Management\\SystemManage_RTC\\SystemManage_RTC.c"
...
#line 10 "Management\\SystemManage_RTC\\SystemManage_RTC.c"
...
void Delay_us_SW(volatile uint32 nCount)
{
...
void IIC_WaitAck(void)
{
	...
	while((GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0080))!= 0) && (k < 60000))
		k++;
...
uint8 IIC_ReadByte(void)
{
	...
	for(i = 0; i < 8; i++)
	{
		...
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0040));
		Delay_us_SW(20);
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0080)))
		{
			ReadByte |= 0x01;
		}
		else

#line 1 "Management\\QRCode\\QRCode.c"
...
#line 1 "Management\\QRCode\\QRCode.h"
...
#line 13 "Management\\QRCode\\QRCode.h"
#line 14 "Management\\QRCode\\QRCode.h"
...
#line 15 "Management\\QRCode\\QRCode.h"
...
#line 10 "Management\\QRCode\\QRCode.c"
#line 11 "Management\\QRCode\\QRCode.c"
...
void QRCode_Uart_Init(void)
{
	...
	QRCode_Uart_GPIO_Init();					 
	QRCode_Uart_NVIC_Configuration();			 
	QRCode_Uart_Config();						 
}
...
void USART1_IRQHandler(void)
{
	...
	{
		value=USART_ReceiveData((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))));
...
void QRCode_Received(void)
{
	...
	if (QRCode_received == 1)
	{
		...
		if (QRCode_Identify())						 
		{
			DisplayDriver_Text16_B(35, 75, 0x001F, 0xFFFF, "Valid QR");
			DisplayDriver_Text16_B(45, 95, 0x001F, 0xFFFF, "Code!");
			QRCode_existed = 1;
		...
		{
			DisplayDriver_Text16_B(27, 85, 0x001F, 0xFFFF, "Invalid QR");
			DisplayDriver_Text16_B(47, 105, 0x001F, 0xFFFF, "Code!");

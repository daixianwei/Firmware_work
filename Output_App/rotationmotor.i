#line 1 "Management\\RotationMotor\\RotationMotor.c"
...
#line 10 "Management\\RotationMotor\\RotationMotor.c"
#line 1 "Management\\RotationMotor\\RotationMotor.h"
...
#line 13 "Management\\RotationMotor\\RotationMotor.h"
#line 14 "Management\\RotationMotor\\RotationMotor.h"
...
#line 43 "Management\\RotationMotor\\RotationMotor.h"
...
#line 11 "Management\\RotationMotor\\RotationMotor.c"
#line 1 "Management\\RotationMotor\\RotationMotorDriver_PositionSensor.h"
...
#line 13 "Management\\RotationMotor\\RotationMotorDriver_PositionSensor.h"

 
#line 21 "Management\\RotationMotor\\RotationMotorDriver_PositionSensor.h"
...
#line 12 "Management\\RotationMotor\\RotationMotor.c"
...
uint8 Num_Down = 1;
u16 Step1[8] = {0x10,0x30,0x20,0x60,0x40,0xc0,0x80,0x90};   
u16 Step2[8] = {0x90,0x80,0xc0,0x40,0x60,0x20,0x30,0x10};   
...
void RotaMotorDriver_GPIO_Init(void)
{
   ...
   GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_PP;
   GPIO_InitStruct.GPIO_Pin  = (((uint16_t)0x0800)) |
...
void RotationMotor_SelfCheck_StepDrive(void)
{
	if(Num_Down)
	{
		...
		while(!(GPIO_ReadInputDataBit((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))), (((uint16_t)0x0004)))))
		{
			RotationMotor_StepDrive_Min((1));
		}
		RotationMotor_Input_StepDrive((1),(512));
		Num_Down = 0;
...
static void RotationMotor_PIN(uint8 Rotation_Direction,u8 MUTU)
{
	...
	{
		case (0):
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x0800)),(Step2[MUTU]&0x10));   
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x1000)),(Step2[MUTU]&0x20));
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x2000)),(Step2[MUTU]&0x40));
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x4000)),(Step2[MUTU]&0x80));
		break;

		case (1):
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x0800)),(Step1[MUTU]&0x10));   
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x1000)),(Step1[MUTU]&0x20));
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x2000)),(Step1[MUTU]&0x40));
			GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),(((uint16_t)0x4000)),(Step1[MUTU]&0x80));
		break;

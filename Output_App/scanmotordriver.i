#line 1 "Management\\ScanMotor\\ScanMotorDriver.c"
...
#line 10 "Management\\ScanMotor\\ScanMotorDriver.c"
...
#line 11 "Management\\ScanMotor\\ScanMotorDriver.c"
...
void Delay_SW(volatile uint32 nCount)
{
	for(; nCount != 0; nCount--);
}
...
void ScanMotorDriver_Control(uint8 enabled) {
	if (enabled)
		GPIO_SetBits((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))), (((uint16_t)0x0040)));
	else
		GPIO_ResetBits((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))), (((uint16_t)0x0040)));
}
...
void ScanMotorDriver_Move(uint8 direction, uint32 steps)
{
	...
	if (direction == 1)
	{
		...
		{
			ScanMotorDriver_MoveOneStep(1);
		}
	}
	else if ((direction == 0) && (steps > 0))
	{

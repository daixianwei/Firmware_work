#line 1 "Management\\Interface\\Interface_Testing.c"
...
#line 1 "Management\\Interface\\Interface_Testing.h"
...
#line 13 "Management\\Interface\\Interface_Testing.h"
...
#line 10 "Management\\Interface\\Interface_Testing.c"
...
#line 11 "Management\\Interface\\Interface_Testing.c"
...
#line 12 "Management\\Interface\\Interface_Testing.c"
...
block_attr_Testing* UI_WindowBlocksAttrArray_Testing[] = { 
		&block_Testing_1,
		&block_Testing_2,
};
...
uint8 Interface_Testing(uint16 KeyCode)
{
	...
	RotationMotor_Input_StepDrive((1),Start_Postion);
...
void Acquisition_Signal(void)
{
	...
	for(i = 0;i<10;i++)
	{
		if(i >= 9)
		{
			RotationMotor_Input_StepDrive((1),53);
		}
		else
		{
			RotationMotor_Input_StepDrive((1),51);
		}
		SignalSample_SampleStrip(0);

		for(j = Step_Start;j < Step_Count;j++)		 
		{
			Delay_ms(30);
			Display_Time = 0;
			Lcd_ColorBox(j,63,1,15,0xC2E0);
			Display_Time = 1;
		}
...
uint16 Get_Start_Postion(void)
{
	...
	for(i = 0;i < (512);i++)
	{
		RotationMotor_Input_StepDrive((1),1);
	...
	SignalSample_Moving_Average_Data(SignalProcess_sampleBuffer,512,5);

	 
	if((Get_sampleBuffer_Max_Value()) < (500))
	{
		Start_Postion = (0);
	...
	for(i = 0;i < 512;i++)
	{
		if(SignalProcess_sampleBuffer[i] < (500))
		{
			SignalProcess_sampleBuffer[i] = 0;
		}
		else
		{
			SignalProcess_sampleBuffer[i] = SignalProcess_sampleBuffer[i] - (500);
		}
	}
